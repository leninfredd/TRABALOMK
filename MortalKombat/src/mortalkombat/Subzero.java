...
private  String socoforte;
  ...
  public String getSocoforte() {
    ...
    public String fatality1() {
        return "Trás, Frente, Baixo, Frente, " + chutefraco + " Distância de uma rasteira. ";
    }

    public String fatality() {
        return "Baixo, Trás, Baixo, Frente,  " + socoforte + " Distância de uma rasteira. ";
    }

    private String supergelo() {
        return "Baixo, Trás," + chuteforte + " Cima, Baixo " + agarra ;
